...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=548443906");
//   <UniversalUI wasmURL="./app.wasm?v=548443906" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=548443906", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=2fb1ea24";
import { packagedBundleProvider } from "./bundle_provider.js?v=ca065710";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=548443906", renderer = "react", style }) {
