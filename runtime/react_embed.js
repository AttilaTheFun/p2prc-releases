...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=2969706655");
//   <UniversalUI wasmURL="./app.wasm?v=2969706655" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=2969706655", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=3ea90675";
import { packagedBundleProvider } from "./bundle_provider.js?v=ca065710";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=2969706655", renderer = "react", style }) {
