...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=3804290573");
//   <UniversalUI wasmURL="./app.wasm?v=3804290573" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=3804290573", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=bdd804fb";
import { packagedBundleProvider } from "./bundle_provider.js?v=ca065710";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=3804290573", renderer = "react", style }) {
